...
const locations = [
    {
        ...
        address: 'Office no-UGF-74, Signature street, Govindpuram, Ghaziabad, Uttar Pradesh, India 201013',
                ...
                <div className="flex flex-wrap justify-center gap-8 max-w-4xl mx-auto">
                    {locations.map((loc, idx) => (
                        <motion.div
                            ...
                            className="group relative bg-gray-50 rounded-2xl border border-gray-200 p-8 hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-400/30 transition-all duration-300 overflow-hidden w-full md:w-[calc(50%-1rem)] max-w-md"
                        >
                            {/* Accent line */}
